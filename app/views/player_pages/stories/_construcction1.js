var story = {
  ...
  [4, "Yes, its easy to build, and as nomads we want something portable and easy to rebuild", "nicubunu_Game_baddie_Candy.png", "left"],
  [5, "Fantastic, they seem like a great idea, can you make many of them?", "nicubunu_Game_baddie_Basic_guy.png", "right"]
  [4, "Yes I can, I'll start workng on them right now", "nicubunu_Game_baddie_Candy.png", "left"],
  [5, "Nice! I was waiting for a moment when we stopped living on trees or caves", "nicubunu_Game_baddie_Basic_guy.png", "right"]],
  //background, frame, tutorial? (small frame)
  "scenes": [["background_tents.jpg", 0, false]],
